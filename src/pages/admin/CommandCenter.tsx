            ...
            {pipelineStages.map((s, i) => {
              ...
              return (
                <div key={s.name} className="flex items-center gap-3">
                  <span className="w-28 text-xs text-muted-foreground">{s.name}</span>
                  <div className="flex-1">
                    <div className="h-6 rounded-sm bg-primary/10">
                      <div
                        ...
                        style={{ width: `${w}%` }}
                      >
                        <span className="text-[10px] font-medium text-primary-foreground">{s.deals} · ${(s.value / 1000000).toFixed(1)}M</span>
                      </div>
                    </div>
                  </div>
                </div>
