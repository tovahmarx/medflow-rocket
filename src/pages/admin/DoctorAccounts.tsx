      ...
      <div className="space-y-3 p-4">
        <div className="flex items-center gap-2">
          <div className="flex flex-1 items-center gap-2 rounded-lg border bg-card px-3 py-2">
            ...
            <input placeholder="Search by name, NPI..." className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground" />
          </div>
          <button className="flex items-center gap-1 rounded-lg bg-primary px-3 py-2.5 text-xs font-medium text-primary-foreground tap-target">
